...
Suction pump lift (stepper): STEP=21, DIR=12 (BCM); EN tied on hardware (see suction_pump_up_down.py). Flask DC pump: flask_suction_pump.py.
...
from flask_suction_pump import cleanup as suction_cleanup
