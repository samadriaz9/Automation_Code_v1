...
| **media_dispensor** | 6 STEP, 16 DIR | EN tied on driver |
...
Typical unused if you only use the table above: **8, 11, 20, 24, 26, 27** (and more). Use these first before reusing anything.
