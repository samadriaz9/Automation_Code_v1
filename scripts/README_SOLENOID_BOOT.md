...
- The repo uses **GPIO 26** for the filtration solenoid (not UART). This avoids UART TX noise on GPIO 14 at boot.
...
- Default code uses **GPIO 26**. If you change `SOLENOID_PIN`, update `solinoid_value_to_filteration.py` and the boot script.
